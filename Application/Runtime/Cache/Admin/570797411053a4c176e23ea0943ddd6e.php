...
<form id="myform" name="myform" method="post" action="" enctype="multipart/form-data">
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
    ...
    <tr><td width="11%" align="right" bgcolor="#FFFFFF">发送主题：</td><td width="89%" bgcolor="#FFFFFF"><input name="title" type="text" id="title" size="32"   /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">红包额度：</td><td width="89%" bgcolor="#FFFFFF"><input name="money_limit" type="text" id="money_limit" size=""   /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">用户分类：</td><td width="89%" bgcolor="#FFFFFF"><?php echo $c77;?></td></tr>
