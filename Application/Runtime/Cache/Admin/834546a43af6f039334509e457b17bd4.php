...
<form id="myform" name="myform" method="post" action="" enctype="multipart/form-data">
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
    ...
    <tr><td width="11%" align="right" bgcolor="#FFFFFF">标题：</td><td width="89%" bgcolor="#FFFFFF"><input name="title" type="text" id="title" size="80" value="<?php echo $result['title'];?>"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">链接：</td><td width="89%" bgcolor="#FFFFFF"><input name="link" type="text" id="link" size="80" value="<?php echo $result['link'];?>"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">内容：</td><td width="89%" bgcolor="#FFFFFF"><textarea name="content" cols="90" rows="15" class="easyui-validatebox" id="content"><?php echo $result['content'];?></textarea></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">接口位置：</td><td width="89%" bgcolor="#FFFFFF"><input name="image" id="image" type="file"></td></tr>
