...
<form id="myform" name="myform" method="post" action="" enctype="multipart/form-data">
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
    ...
    <input type="hidden" id="userid"  name="userid" value="<?php echo $_GET['userid']?>"><tr><td width="11%" align="right" bgcolor="#FFFFFF">订单id：</td><td width="89%" bgcolor="#FFFFFF"><input name="orderid" type="text" id="orderid" size="11"   /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">服务星级：</td><td width="89%" bgcolor="#FFFFFF"><input name="xingji" type="text" id="xingji" size="11"   /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">评价内容：</td><td width="89%" bgcolor="#FFFFFF"><input name="content" type="text" id="content" size="80"   /></td></tr>
