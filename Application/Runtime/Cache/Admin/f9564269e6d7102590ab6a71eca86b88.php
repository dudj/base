...
<head id="Head1">
   ...
   <link rel="stylesheet" type="text/css" href="/public/easyui1.3/themes/default/easyui.css">
	...
	KindEditor.ready(function(K) {
		...
		$('#myform').form({
			url:'/admin/wechatkeywords/saveadd',
			onSubmit: function(){
				$fly.load();
			},
...
<form id="myform" name="myform" method="post" action="" enctype="multipart/form-data">
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
    ...
    <tr><td width="11%" align="right" bgcolor="#FFFFFF">关键字：</td><td width="89%" bgcolor="#FFFFFF"><input name="keyword" type="text" id="keyword" size="80"   /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">回复内容：</td><td width="89%" bgcolor="#FFFFFF"><textarea name="response" cols="80" rows="8"  id="response"></textarea></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">微信回复语类型：</td><td width="89%" bgcolor="#FFFFFF"><?php echo $c2;?></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">微信回复语状态：</td><td width="89%" bgcolor="#FFFFFF"><?php echo $c10;?></td></tr>
