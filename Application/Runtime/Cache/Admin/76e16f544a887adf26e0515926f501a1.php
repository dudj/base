...
<form id="myform" name="myform" method="post" action="" enctype="multipart/form-data">
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
    ...
    <tr><td width="11%" align="right" bgcolor="#FFFFFF">版本号：</td><td width="89%" bgcolor="#FFFFFF"><input name="view_number" type="text" id="view_number" size="11" value="<?php echo $result['view_number'];?>"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">安卓url地址：</td><td width="89%" bgcolor="#FFFFFF"><input name="android_url" type="text" id="android_url" size="80" value="<?php echo $result['android_url'];?>"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">IOS地址：</td><td width="89%" bgcolor="#FFFFFF"><input name="ios_url" type="text" id="ios_url" size="80" value="<?php echo $result['ios_url'];?>"  /></td></tr>
