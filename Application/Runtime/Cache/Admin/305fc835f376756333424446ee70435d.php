...
<head id="Head1">
   ...
   <link rel="stylesheet" type="text/css" href="/public/easyui1.3/themes/default/easyui.css">
	...
	par = K.create('textarea[name="par"]', {allowFileManager : true});
		
		$('#myform').form({
			url:'/admin/api2/saveadd',
			onSubmit: function(){
				$fly.load();
			},
...
<form id="myform" name="myform" method="post" action="" enctype="multipart/form-data">
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
    ...
    <tr><td width="11%" align="right" bgcolor="#FFFFFF">接口名称：</td><td width="89%" bgcolor="#FFFFFF"><input name="name" type="text" id="name" size="50"   /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">sql语句：</td><td width="89%" bgcolor="#FFFFFF"><textarea name="sql" cols="80" rows="8"  id="sql"></textarea></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">参数说明：</td><td width="89%" bgcolor="#FFFFFF"><textarea name="par" cols="90" rows="15" id="par"></textarea></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">图片：</td><td width="89%" bgcolor="#FFFFFF"><input name="image" id="image" type="file"></td></tr>
