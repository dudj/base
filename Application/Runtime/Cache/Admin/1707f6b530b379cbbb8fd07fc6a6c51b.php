...
<form id="myform" name="myform" method="post" action="" enctype="multipart/form-data">
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
    ...
    <tr><td width="11%" align="right" bgcolor="#FFFFFF">统计时间：</td><td width="89%" bgcolor="#FFFFFF"><input name="day" type="text" id="day" size="20" onclick="SelectDate(this,'yyyy-MM-dd hh:mm:ss')" class="easyui-validatebox" required="true"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">统计数量：</td><td width="89%" bgcolor="#FFFFFF"><input name="register_number" type="text" id="register_number" size="11"   /></td></tr>
