...
<form id="myform" name="myform" method="post" action="" enctype="multipart/form-data">
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
    ...
    <tr><td width="11%" align="right" bgcolor="#FFFFFF">充值方式：</td><td width="89%" bgcolor="#FFFFFF"><?php echo $c99;?></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">充值金额：</td><td width="89%" bgcolor="#FFFFFF"><input name="money" type="text" id="money" size="" value="<?php echo $result['money'];?>"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">充值状态：</td><td width="89%" bgcolor="#FFFFFF"><?php echo $c103;?></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">订单号：</td><td width="89%" bgcolor="#FFFFFF"><input name="orderNumber" type="text" id="orderNumber" size="32" value="<?php echo $result['orderNumber'];?>"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">用户昵称：</td><td width="89%" bgcolor="#FFFFFF"><input name="nickname" type="text" id="nickname" size="32" value="<?php echo $result['nickname'];?>"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">微信签名：</td><td width="89%" bgcolor="#FFFFFF"><input name="prepay_id" type="text" id="prepay_id" size="32" value="<?php echo $result['prepay_id'];?>"  /></td></tr>
