...
<head id="Head1">
   ...
   <link rel="stylesheet" type="text/css" href="/public/easyui1.3/themes/default/easyui.css">
	...
	musicurl = K.create('textarea[name="musicurl"]', {allowFileManager : true});hdmusicurl = K.create('textarea[name="hdmusicurl"]', {allowFileManager : true});
		...
		$('#myform').form({
			url:'/admin/wechatreplymusic/saveadd',
			onSubmit: function(){
				$fly.load();
			},
...
<form id="myform" name="myform" method="post" action="" enctype="multipart/form-data">
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
    ...
    <tr><td width="11%" align="right" bgcolor="#FFFFFF">关键词：</td><td width="89%" bgcolor="#FFFFFF"><input name="keyword" type="text" id="keyword" size="80" class="easyui-validatebox" required="true" validType="length[0,254]"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">音乐标题：</td><td width="89%" bgcolor="#FFFFFF"><input name="title" type="text" id="title" size="64" class="easyui-validatebox" required="true" validType="length[0,64]"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">音乐描述：</td><td width="89%" bgcolor="#FFFFFF"><textarea name="description" cols="80" rows="8"  id="description"></textarea></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">音乐url：</td><td width="89%" bgcolor="#FFFFFF"><textarea name="musicurl" cols="90" rows="15" id="musicurl"></textarea></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">高清音乐url：</td><td width="89%" bgcolor="#FFFFFF"><textarea name="hdmusicurl" cols="90" rows="15" id="hdmusicurl"></textarea></td></tr>
    <tr>
