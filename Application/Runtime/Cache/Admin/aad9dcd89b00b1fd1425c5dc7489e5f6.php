...
<form id="myform" name="myform" method="post" action="" enctype="multipart/form-data">
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
    ...
    <input type="hidden" id="user_infoid"  name="user_infoid" value="<?php echo $_GET['user_infoid']?>"><input type="hidden" id="shop_infoid"  name="shop_infoid" value="<?php echo $_GET['shop_infoid']?>"><tr><td width="11%" align="right" bgcolor="#FFFFFF">评论内容：</td><td width="89%" bgcolor="#FFFFFF"><textarea name="connent" cols="80" rows="8"  id="connent"></textarea></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">评论图片：</td><td width="89%" bgcolor="#FFFFFF"><input name="commentsimg[]" id="commentsimg[]" type="file" multiple="true"></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">评论级别：</td><td width="89%" bgcolor="#FFFFFF"><input name="grade" type="text" id="grade" size="4"   /></td></tr>
