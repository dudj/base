...
<form id="myform" name="myform" method="post" action="" enctype="multipart/form-data">
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
    ...
    <tr><td width="11%" align="right" bgcolor="#FFFFFF">用户名称：</td><td width="89%" bgcolor="#FFFFFF"><input name="nickname" type="text" id="nickname" size="32" value="<?php echo $result['nickname'];?>"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">服务星级：</td><td width="89%" bgcolor="#FFFFFF"><input name="degree" type="text" id="degree" size="32" value="<?php echo $result['degree'];?>"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">评价内容：</td><td width="89%" bgcolor="#FFFFFF"><input name="content" type="text" id="content" size="80" value="<?php echo $result['content'];?>"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">订单号：</td><td width="89%" bgcolor="#FFFFFF"><input name="order_number" type="text" id="order_number" size="32" value="<?php echo $result['order_number'];?>"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">用户分类：</td><td width="89%" bgcolor="#FFFFFF"><?php echo $c77;?></td></tr>
