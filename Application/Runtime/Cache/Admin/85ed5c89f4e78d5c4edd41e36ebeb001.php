...
<form id="myform" name="myform" method="post" action="" enctype="multipart/form-data">
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
    ...
    <tr><td width="11%" align="right" bgcolor="#FFFFFF">用户手机号：</td><td width="89%" bgcolor="#FFFFFF"><input name="news_phone" type="text" id="news_phone" size="32" value="<?php echo $result['news_phone'];?>"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">消息内容：</td><td width="89%" bgcolor="#FFFFFF"><textarea name="news_content" cols="90" rows="15" class="easyui-validatebox" id="news_content"><?php echo $result['news_content'];?></textarea></td></tr>
