...
<form id="myform" name="myform" method="post" action="" enctype="multipart/form-data">
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
    ...
    <tr><td width="11%" align="right" bgcolor="#FFFFFF">银行卡号：</td><td width="89%" bgcolor="#FFFFFF"><input name="num" type="text" id="num" size="32" value="<?php echo $result['num'];?>"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">银行名称：</td><td width="89%" bgcolor="#FFFFFF"><input name="name" type="text" id="name" size="50" value="<?php echo $result['name'];?>"  /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">用户名：</td><td width="89%" bgcolor="#FFFFFF"><input name="username" type="text" id="username" size="32" value="<?php echo $result['username'];?>"  /></td></tr>
