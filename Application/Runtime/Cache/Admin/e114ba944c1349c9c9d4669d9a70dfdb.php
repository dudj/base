...
<form id="myform" name="myform" method="post" action="" enctype="multipart/form-data">
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
    ...
    <tr><td width="11%" align="right" bgcolor="#FFFFFF">工种名称：</td><td width="89%" bgcolor="#FFFFFF"><input name="typeName" type="text" id="typeName" size="50"   /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">描述：</td><td width="89%" bgcolor="#FFFFFF"><textarea name="title" cols="80" rows="8"  id="title"></textarea></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">工资：</td><td width="89%" bgcolor="#FFFFFF"><input name="money" type="text" id="money" size=""   /></td></tr>
