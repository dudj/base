...
<form id="myform" name="myform" method="post" action="" enctype="multipart/form-data">
  <table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
    ...
    <input type="hidden" id="userid"  name="userid" value="<?php echo $_GET['userid']?>"><input type="hidden" id="sendxqid"  name="sendxqid" value="<?php echo $_GET['sendxqid']?>"><tr><td width="11%" align="right" bgcolor="#FFFFFF">用户名称：</td><td width="89%" bgcolor="#FFFFFF"><input name="nickname" type="text" id="nickname" size="32"   /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">订单号：</td><td width="89%" bgcolor="#FFFFFF"><input name="ddh" type="text" id="ddh" size="32"   /></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">工人状态：</td><td width="89%" bgcolor="#FFFFFF"><?php echo $c88;?></td></tr><tr><td width="11%" align="right" bgcolor="#FFFFFF">辞退原因：</td><td width="89%" bgcolor="#FFFFFF"><input name="content" type="text" id="content" size="80"   /></td></tr>
